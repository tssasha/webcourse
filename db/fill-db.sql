...
INSERT INTO topics VALUES
                        (DEFAULT, 'Про отладку программ', 'Java для начинающих'),
                        (DEFAULT, 'Сравнение строк (String) в java. Мини гайд для начинающих', 'Java для начинающих'),
                        (DEFAULT, 'Прозрачные окна в JAVA', 'Java: GUI, Графика')

INSERT INTO messages VALUES
                        (DEFAULT, 1, 'Не знаю, потянет ли на "важную" тему, но можно ссылкой на эту, уже кидаться)).' ||
                                                 '
======================================' ||
                                                 '
...
Во всех современных IDE существует возможность запускать разрабатываемые программы в режиме отладки. Например, в IDEA ' ||
                         ...
                         (DEFAULT, 1, 'можно еще, например, добавить как стримы дебажить', 'lifestyle', '21/01/2019 11:56'),
                         (DEFAULT, 1, 'дебажить стримы не самое простое и интересное занятие, вот подсказочка, как это можно сделать наглядно' ||
                          ...
                          (DEFAULT, 2, 'Всем привет! ' ||
                                ...
                                'String s1 = “com.hello”;' ||
                                'String s2 = new String (“com.hello”);' ||
                          ...
                          (DEFAULT, 2, 'Иногда строку, допустим полученную ' ||
                          ...
                          (DEFAULT, 2, 'ты главное не объясняй почему) новичкам же не интересно',
                           'Welemir1', '06/09/2018 12:33'),
                          (DEFAULT, 2, 'Договорились, про возможный inputUser = null, можешь рассказать сам)).',
                           'Aviz__', '06/09/2018 12:39'),
                          (DEFAULT, 3, 'Вот случайно наткнулся в нете на такие статейки, ранее тоже натыкался , ' ||
                          ...
                          (DEFAULT, 3, 'Интерсно-интересно. Так это родной параметр? Без сторонних библиотек, значит?' ||
                               'Мда.. действительно работает.' ||
                               'Прикольно..' ||
                               'Я у себя подсказки всплывающие так сделал теперь.', 'InvalidCode', '14/01/2016 23:05'),
                          (DEFAULT, 3, 'И без этого можно - Component.setTooltipText()', 'Programming', '11/06/2017 12:13');
