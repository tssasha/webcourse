...
Во всех современных IDE существует возможность запускать разрабатываемые программы в режиме отладки. Например, в IDEA ' ||
                         ...
                         (DEFAULT, 'Про отладку программ', 'можно еще, например, добавить как стримы дебажить', 'lifestyle', '21/01/2019 11:56'),
                         (DEFAULT, 'Про отладку программ', 'дебажить стримы не самое простое и интересное занятие, вот подсказочка, как это можно сделать наглядно' ||
                          ...
                          (DEFAULT, 'Сравнение строк (String) в java. Мини гайд для начинающих', 'Всем привет! ' ||
                          ...
                          (DEFAULT, 'Сравнение строк (String) в java. Мини гайд для начинающих', 'Иногда строку, допустим полученную ' ||
                          ...
                          (DEFAULT, 'Сравнение строк (String) в java. Мини гайд для начинающих', 'ты главное не объясняй почему) новичкам же не интересно',
                           'Welemir1', '06/09/2018 12:33'),
                          (DEFAULT, 'Сравнение строк (String) в java. Мини гайд для начинающих', 'Договорились, про возможный inputUser = null, можешь рассказать сам)).',
                           'Aviz__', '06/09/2018 12:39'),
                          (DEFAULT, 'Прозрачные окна в JAVA', 'Вот случайно наткнулся в нете на такие статейки, ранее тоже натыкался , ' ||
                          ...
                          (DEFAULT, 'Прозрачные окна в JAVA', 'Интерсно-интересно. Так это родной параметр? Без сторонних библиотек, значит?' ||
