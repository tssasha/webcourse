...
public class MessageServiceTest {
    ...
    public void testSaveMessage() {
        ...
        Message new_message = new Message(1, "Новое сообщение", "InvalidCode", java.sql.Timestamp.valueOf("2021-03-23 14:34:00"));
        messageService.saveMessage(new_message);

        List<Message> check_message = messageService.findAllMessagesInTopic(1);
    ...
    public void testDeleteMessage() {
        ...
        List<Message> check_message1 = messageService.findAllMessagesInTopic(1);
        messageService.deleteMessage(new_message);

        List<Message> check_message2 = messageService.findAllMessagesInTopic(1);
    ...
    public void testFindAllMessagesInTopic() {
        MessageService messageService = new MessageService();
        Set<Message> expected_list = Set.of(new Message(3, "Вот случайно наткнулся в нете на такие статейки, " +
                ...
                new Message(3, "Интерсно-интересно. Так это родной параметр? Без сторонних библиотек, значит?" +
                ...
                new Message(3, "И без этого можно - Component.setTooltipText()", "Programming", java.sql.Timestamp.valueOf("2017-06-11 12:13:00")));

        List<Message> check_messages = messageService.findAllMessagesInTopic(3);
